 ...
 * This file demonstrates how to integrate Karmairis with a web frontend
 */

// For React/Vue/Angular applications
export class KarmairisClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new KarmairisClient(provider, contractAddress);
